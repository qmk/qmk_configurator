...
module.exports = function Translate() {
   ...
   */
  this.ToTraditionalChinese = function (text, type) {
    if (type == undefined) {
      type = 0;
    }
    if (type > 2 || type < 0) {
   ...
   */
  this.ToSimplifiedChinese = function (text, srcType) {
  ...
  function TransformationReplace(text, wordsSearch) {
  ...
  function GetWordsSearch(s2t, srcType) {
    if (s2t) {
      if (srcType == 0) {
        if (s2tSearch == null) {
  ...
  function BuildWordsSearch(keywords, toWords) {
