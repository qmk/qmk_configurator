$(document).ready(() => {
  ...
  function getKeycodes() {
    return [
      ...
      { name: 'Toggle', code: 'BL_TOGG' },
      { name: '+', code: 'BL_INC' },
      { name: '-', code: 'BL_DEC' },
      { name: 'Cycle', code: 'BL_STEP' },

      { label: 'RGB Lighting settings', width: 'label' },

      { name: 'Toggle', code: 'RGB_TOG' },
      { name: 'Mode+', code: 'RGB_MOD' },
      { name: 'Mode-', code: 'RGB_RMOD' },
      ...
      { name: 'Plain', code: 'RGB_M_P', title: 'Plain' },
      { name: 'Breathe', code: 'RGB_M_B', title: 'Breathe' },
      { name: 'Rainbow', code: 'RGB_M_R', title: 'Rainbow' },
      { name: 'Swirl', code: 'RGB_M_SW', title: 'Swirl' },
      { name: 'Snake', code: 'RGB_M_SN', title: 'Snake' },
      { name: 'Knight', code: 'RGB_M_K', title: 'Knight' },
      { name: 'Xmas', code: 'RGB_M_X', title: 'Xmas' },
      { name: 'Gradient', code: 'RGB_M_G', title: 'Gradient' },
