export const longFormKeycodes = {
  ...
  // Long-Form OSM
  'OSM(MOD_LCTL)': 'OS_LCTL',
  'OSM(MOD_LSFT)': 'OS_LSFT',
  'OSM(MOD_LALT)': 'OS_LALT',
  'OSM(MOD_LGUI)': 'OS_LGUI',
  'OSM(MOD_LCTL|MOD_LSFT)': 'OS_LCS',
  'OSM(MOD_LCTL|MOD_LALT)': 'OS_LCA',
  'OSM(MOD_LCTL|MOD_LGUI)': 'OS_LCG',
  'OSM(MOD_LSFT|MOD_LALT)': 'OS_LSA',
  'OSM(MOD_LSFT|MOD_LGUI)': 'OS_LSG',
  'OSM(MOD_LALT|MOD_LGUI)': 'OS_LAG',
  'OSM(MOD_LCTL|MOD_LSFT|MOD_LGUI)': 'OS_LCSG',
  'OSM(MOD_LCTL|MOD_LALT|MOD_LGUI)': 'OS_LCAG',
  'OSM(MOD_LSFT|MOD_LALT|MOD_LGUI)': 'OS_LSAG',
  'OSM(MOD_RCTL)': 'OS_RCTL',
  'OSM(MOD_RSFT)': 'OS_RSFT',
  'OSM(MOD_RALT)': 'OS_RALT',
  'OSM(MOD_RGUI)': 'OS_RGUI',
  'OSM(MOD_RCTL|MOD_RSFT)': 'OS_RCS',
  'OSM(MOD_RCTL|MOD_RALT)': 'OS_RCA',
  'OSM(MOD_RCTL|MOD_RGUI)': 'OS_RCG',
  'OSM(MOD_RSFT|MOD_RALT)': 'OS_RSA',
  'OSM(MOD_RSFT|MOD_RGUI)': 'OS_RSG',
  'OSM(MOD_RALT|MOD_RGUI)': 'OS_RAG',
  'OSM(MOD_RCTL|MOD_RSFT|MOD_RGUI)': 'OS_RCSG',
  'OSM(MOD_RCTL|MOD_RALT|MOD_RGUI)': 'OS_RCAG',
  'OSM(MOD_RSFT|MOD_RALT|MOD_RGUI)': 'OS_RSAG',
  'OSM(MOD_MEH)': 'OS_MEH',
  'OSM(MOD_HYPR)': 'OS_HYPR',
