export default [
  ...
  { name: '_\n-', code: 'KC_MINS', keys: '-', title: '- and =' },
  { name: '+\n=', code: 'KC_EQL', keys: '=', title: '= and +' },
  { name: '|\n¥', code: 'KC_INT3', title: 'International 3 (JIS ¥ and |)' },
  {
    name: 'Back Space',
    code: 'KC_BSPC',
    keys: 'backspace',
  ...
  { name: '_\n\\', code: 'KC_INT1', title: 'International 1 (JIS \\ and _)' },
  { name: 'Right Shift', code: 'KC_RSFT', title: 'Right Shift', width: 1750 },
  ...
  },
  {
    name: '無変換',
    code: 'KC_INT5',
    title: 'International 5 (JIS Muhenkan)',
    width: 1250
  },
  {
    name: 'Space',
  ...
  },
  {
    name: '変換',
    code: 'KC_INT4',
    title: 'International 4 (JIS Henkan)',
    width: 1250
  },
  {
    name: 'カタカナ\nひらがな',
    code: 'KC_INT2',
    title: 'International 2 (JIS Katakana/Hiragana)',
    styles: { 'font-size': '8px' },
    width: 1250
  },
  { name: 'Alt Gr', code: 'KC_RALT', title: 'Right Alt (Option/AltGr)' },
  {
    name: 'Right GUI',
    code: 'KC_RGUI',
  ...
  { name: '≡', code: 'KC_APP', title: 'Application (Windows Context Menu)' },
...

  {
    name: '한영\nかな',
    code: 'KC_LNG1',
    title: 'Language 1 (Korean Han/Yeong; Japanese Mac Kana)',
    width: 1250
  },
  {
    name: '漢字\n英数',
    code: 'KC_LNG2',
    title: 'Language 2 (Korean Hanja; Japanese Mac Eisu)',
    width: 1250
  },
