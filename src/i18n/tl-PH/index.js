    ...
    message: {
      ...
      settingsPanel: {
        ...
        fastInput: {
          ...
          title: 'ctrl + alt + f',
          help:
            'I-input ang mga keys gamit ang keyboard nang hindi nagki-click ng kada posisyon.'
        },
        displaySizes: {
      ...
      errors: {
        invalidQMKKeymap: 'Paumanhin, hindi valid ang QMK keymap file.',
        ...
        unsupportedBrowser:
          'Gumagamit ka ng hindi sinusuportahang browser. Paki-gamitin ang'
      },
      statsTemplate:
