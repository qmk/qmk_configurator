...
export default {
  ...
  'A(KC_NUHS)': { name: '¶', title: 'IT_PILC' },
  // Row 4
  'A(KC_NUBS)': { name: '≤', title: 'IT_LTEQ' },
   ...
   */
  // Row 1
  'S(A(KC_GRV))': { name: 'ı', title: 'IT_DLSI' },
  ...
  'S(A(KC_NUHS))': { name: '◊', title: 'IT_LOZN' },
  // Row 4
  'S(A(KC_NUBS))': { name: '≥', title: 'IT_GTEQ' },
