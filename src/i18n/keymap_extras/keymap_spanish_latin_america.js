/* Copyright 2024 - Generated by convert_keymap_extras_header.js
 *
...
export default {
   ...
   */
  // Row 1
  'S(KC_GRV)': { name: '°', title: 'ES_MORD' },
  KC_TILD: { name: '°', title: 'ES_MORD' },
  ...
  // Row 2
  'S(KC_LBRC)': { name: '¨', title: 'ES_DIAE (dead)' },
  KC_LCBR: { name: '¨', title: 'ES_DIAE (dead)' },
   ...
   */
  // Row 1
  'ALGR(KC_GRV)': { name: '¬', title: 'ES_NOT' },
  'ALGR(KC_MINS)': { name: '\\', title: 'ES_BSLS' },
  // Row 2
  'ALGR(KC_Q)': { name: '@', title: 'ES_AT' },
  'ALGR(KC_RBRC)': { name: '~', title: 'ES_TILD' },
  // Row 3
  'ALGR(KC_QUOT)': { name: '^', title: 'ES_CIRC' },
  'ALGR(KC_NUHS)': { name: '`', title: 'ES_GRV (dead)' },
