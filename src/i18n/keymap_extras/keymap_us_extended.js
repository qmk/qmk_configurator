...
export default {
   ...
   */
  // Row 1
  'S(KC_GRV)': { name: '~', title: 'US_TILD' },
  KC_TILD: { name: '~', title: 'US_TILD' },
  ...
  'S(KC_6)': { name: '^', title: 'US_CIRC' },
  KC_CIRC: { name: '^', title: 'US_CIRC' },
  ...
  'S(KC_QUOT)': { name: '"', title: 'US_DQUO' },
  KC_DQUO: { name: '"', title: 'US_DQUO' },
  // Row 4
   ...
   */
  // Row 1
  'ALGR(KC_GRV)': { name: '`', title: 'US_DGRV (dead)' },
  'ALGR(KC_1)': { name: '¹', title: 'US_SUP1' },
  'ALGR(KC_2)': { name: '²', title: 'US_SUP2' },
  'ALGR(KC_3)': { name: '³', title: 'US_SUP3' },
  'ALGR(KC_4)': { name: '¤', title: 'US_CURR' },
  'ALGR(KC_5)': { name: '€', title: 'US_EURO' },
  'ALGR(KC_6)': { name: '^', title: 'US_DCIR (dead)' },
  'ALGR(KC_7)': { name: '◌̛', title: 'US_HORN (dead)' },
  'ALGR(KC_8)': { name: '˛', title: 'US_OGON (dead)' },
  ...
  'ALGR(KC_R)': { name: 'Ë', title: 'US_EDIA' },
   ...
   */
  // Row 1
  'S(ALGR(KC_GRV))': { name: '~', title: 'US_DTIL (dead)' },
  'S(ALGR(KC_1))': { name: '¡', title: 'US_IEXL' },
  ...
  'S(ALGR(KC_6))': { name: '¼', title: 'US_QRTR' },
  'S(ALGR(KC_7))': { name: '½', title: 'US_HALF' },
  'S(ALGR(KC_8))': { name: '¾', title: 'US_TQTR' },
  ...
  'S(ALGR(KC_QUOT))': { name: '¨', title: 'US_DIAE (dead)' },
  // Row 4
